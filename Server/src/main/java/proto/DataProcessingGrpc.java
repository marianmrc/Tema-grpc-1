...
public final class DataProcessingGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Server.DataRequest,
      proto.Server.DataResponse> getProcessDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "processData",
      requestType = proto.Server.DataRequest.class,
      responseType = proto.Server.DataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Server.DataRequest,
      proto.Server.DataResponse> getProcessDataMethod() {
    io.grpc.MethodDescriptor<proto.Server.DataRequest, proto.Server.DataResponse> getProcessDataMethod;
      ...
      synchronized (DataProcessingGrpc.class) {
        if ((getProcessDataMethod = DataProcessingGrpc.getProcessDataMethod) == null) {
          DataProcessingGrpc.getProcessDataMethod = getProcessDataMethod = 
              io.grpc.MethodDescriptor.<proto.Server.DataRequest, proto.Server.DataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "DataProcessing", "processData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Server.DataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Server.DataResponse.getDefaultInstance()))
  ...
  public static abstract class DataProcessingImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void processData(proto.Server.DataRequest request,
        io.grpc.stub.StreamObserver<proto.Server.DataResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Server.DataRequest,
                proto.Server.DataResponse>(
  ...
  public static final class DataProcessingBlockingStub extends io.grpc.stub.AbstractStub<DataProcessingBlockingStub> {
    ...
    /**
     */
    public proto.Server.DataResponse processData(proto.Server.DataRequest request) {
  ...
  public static final class DataProcessingFutureStub extends io.grpc.stub.AbstractStub<DataProcessingFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Server.DataResponse> processData(
        proto.Server.DataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_DATA:
          serviceImpl.processData((proto.Server.DataRequest) request,
              (io.grpc.stub.StreamObserver<proto.Server.DataResponse>) responseObserver);
          break;
        default:
